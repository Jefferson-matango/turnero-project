        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form class="max-w-md mx-auto mt-6" autocomplete="off" action="{{route('posts.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <label name="description" id="description" for="message" class="block mb-2 text-lg font-medium text-gray-500 dark:text-gray-400">
                                Descripcion
                            </label>
                            <textarea for="description" id="message" rows="4" class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border 
                                border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 
                                dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                placeholder="Describe tu post"></textarea>
                        </div>
